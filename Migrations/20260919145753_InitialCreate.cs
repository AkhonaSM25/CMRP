        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Campus = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationDetail = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssignmentHistory_AspNetUsers_ChangedById",
                        column: x => x.ChangedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssignmentHistory_AspNetUsers_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssignmentHistory_AspNetUsers_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssignmentHistory_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ReportId = table.Column<int>(type: "INTEGER", nullable: false),
                    StoredName = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatusHistory_AspNetUsers_ChangedById",
                        column: x => x.ChangedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StatusHistory_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentHistory_ChangedById",
                table: "AssignmentHistory",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentHistory_FromUserId",
                table: "AssignmentHistory",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentHistory_ReportId",
                table: "AssignmentHistory",
                column: "ReportId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentHistory_ToUserId",
                table: "AssignmentHistory",
                column: "ToUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_Campus_Building",
                table: "Locations",
                columns: new[] { "Campus", "Building" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusHistory_ChangedById",
                table: "StatusHistory",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_StatusHistory_ReportId",
                table: "StatusHistory",
                column: "ReportId");
        }
